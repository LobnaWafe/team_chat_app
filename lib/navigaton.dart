  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        elevation: 8,
        selectedFontSize: 0, // نخفي اللابل تماماً
        unselectedFontSize: 0,
        onTap: changeIndex,
        items: [
          BottomNavigationBarItem(
            icon: Padding(
              padding: const EdgeInsets.only(bottom: 6), // نزل الأيقونة شوية
              child: AnimatedScale(
                scale: _currentIndex == 0 ? 1.5 : 1, // تكبير أساسي + أكبر عند التفعيل
                duration: const Duration(milliseconds: 200),
                curve: Curves.easeInOut,
                child: Icon(
                  _currentIndex == 0 ? Icons.home_rounded : Icons.home_outlined,
                  size: 28, // حجم الأيقونة الأساسي
